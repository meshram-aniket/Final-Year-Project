...
export default function Cards() {
  ...
  const serviceData = [
    {
      Service: "PLUMBER",
      Description: "Fixing Leaks, connecting lives",
    ...
    {
      Service: "PAINTER",
      Description: "Transforming spaces one brushstroke at a time",
    ...
    {
      Service: "ELECTRICIAN",
      Description: "Empowering sparks, connecting electricians",
    ...
    },
    {
      ...
      Description: "Protecting homes with expert care",
    ...
    {
      Service: "CARPENTER",
      Description: "Crafting dreams, building realities",
  ...
  return (
    ...
    //             <div className="des">
    //               Empowering sparks, connecting electricians
    //             </div>
    //             <button className="btn btn-light cursor-scale">
    //               <NavLink
    //                 style={{ textDecoration: "none", color: "black" }}
